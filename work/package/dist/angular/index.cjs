...
__export(angular_exports, {
  KhmerNormalizePipe: () => KhmerNormalizePipe,
  KhmerSegmentService: () => KhmerSegmentService
});
...
var KhmerSegmentService = class {
  ...
  createDictionary(words, frequencies) {
    return createDictionary(words, frequencies);
  }
};
KhmerSegmentService = __decorateClass([
  (0, import_core.Injectable)({
    providedIn: "root"
  })
], KhmerSegmentService);
var KhmerNormalizePipe = class {
  transform(value) {
    if (value == null) {
      return "";
    }
...
KhmerNormalizePipe = __decorateClass([
  (0, import_core.Pipe)({
    name: "khmerNormalize",
    standalone: true,
    pure: true
